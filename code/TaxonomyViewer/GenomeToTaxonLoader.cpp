...
void GenomeToTaxonLoader::getNext(GenomeIdentifier*genome,TaxonIdentifier*taxon){
	...
	//std::cout << "genome " << tmpGenome << " linked to taxon " << loadedTaxon << std::endl;
    loadedGenome = hash_content(tmpGenome);
	//std::cout << "genome " << tmpGenome << " linked to taxon " << loadedTaxon << std::endl;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           << " linked to taxon " << loadedTaxon << std::endl;
	(*genome)= loadedGenome;
	(*taxon)=loadedTaxon;
    std::cout << "genome : " << (*genome) << "linked to taxon " << (*taxon) << std::endl;
	m_current++;
